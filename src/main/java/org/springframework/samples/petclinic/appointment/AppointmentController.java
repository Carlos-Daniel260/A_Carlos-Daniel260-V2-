...
public class AppointmentController {
    ...
    public AppointmentController(AppointmentRepository appointmentRepository, SpecialtieRepository specialtieRepository,
            MascotasRepository mascotasRepository, VetRepository vetRepository) {
    ...
    public String report(Map<String, Object> model, @PathVariable("specialtieId") int specialtieId) {
        ...
        Collection<Mascotas> allPets = this.mascotasRepository.getMascotas();
        model.put("allPets", allPets);
        System.out.print(allPets.toString() + " ______________________");
