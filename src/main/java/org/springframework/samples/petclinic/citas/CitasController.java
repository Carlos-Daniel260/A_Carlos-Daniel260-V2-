...
public class CitasController {
    ...
    // private static final String GETCITA = "citas/receta/{citaId}";
    private static final String GETCITA = "citas/receta/{id}";
    ...
    public CitasController(CitasRepository clinicService, EspecialidadesRepository especialidadesRepository,
    ...
    public String processMakeCita(@Valid Citas cita, BindingResult result) {
        ...
        if (result.hasErrors()) {
            ...
            Owner owner_temp = this.owners.findByUserId(temp.getId());
            /*
             * String temp_pass = owner_temp.getUser().getPassword(); String temp_username =
             * owner_temp.getUser().getEmail();
             */
    ...
    public String citaFormAdmin(Map<String, Object> model, Owner owner) {
        ...
        /*
         * User temp = userRepository.findByEmail(username); Collection<Owner> owners =
         * this.owners.All(); System.out.println("usuario: " + temp);
         * System.out.println("numero jaja: " + temp.getId());
         * System.out.println("owner encontrado: " + owner_temp);
         * System.out.println("id del owner encontrado: " + owner_temp.getId());
         */
    ...
    public String processMakeCitaAdmin(@Valid Citas cita, BindingResult result) {
        ...
        if (result.hasErrors()) {
            ...
            /*
             * User temp = userRepository.findByEmail(username); Owner owner_temp =
             * this.owners.findByUserId(temp.getId()); String temp_pass =
             * owner_temp.getUser().getPassword(); String temp_username =
             * owner_temp.getUser().getEmail();
             * 
             * System.out.println("usuario: " + temp); System.out.println("numero jaja: " +
             * temp.getId()); System.out.println("owner encontrado: " + owner_temp);
             * System.out.println("id del owner encontrado: " + owner_temp.getId());
             * 
             * cita.setOwner(owner_temp);
             */
            /*
             * System.out.println("id del que estoy editandos, seniors homeros: " +
             * cita.getId());
             * 
             * System.out.println("cita con datos nuevos: " + cita);
             * 
    ...
    public String endCita(@Valid Citas cita, BindingResult result) {
        System.out.println(result);
        /*
         * if (result.hasErrors()) { System.out.println("MAL"); return VIEW_SELEC_PET; }
         * else {
         */
        String username = "";
        Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
